...
class PingMessage implements ClientMessage, ServerMessage {
  const PingMessage({this.payload});

  PingMessage.fromJson(Map<String, dynamic> json) : payload = json['payload'];
  ...
  @override
  String toString() => 'PingMessage(payload: $payload)';
}
